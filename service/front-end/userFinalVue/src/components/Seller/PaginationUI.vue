  ...
  <nav aria-label="Page navigation">
    <ul class="pagination justify-content-center">
      ...
      <li
        ...
        :key="index"
        v-bind:class="{ active: startPageIndex + index - 1 == $store.state.PropertyManage.currentPageIndex }"
        class="page-item"
      >
...
export default {
  ...
  computed: {
    pageCount: function () {
      return this.$store.getters.getMyPropertyPageCount;
    },
    startPageIndex: function () {
      return this.$store.getters.getMyPropertyStartPageIndex;
    },
    endPageIndex: function () {
      return this.$store.getters.getMyPropertyEndPageIndex;
    },
    prev: function () {
      return this.$store.getters.getMyPropertyPrev;
    },
    next: function () {
      return this.$store.getters.getMyPropertyNext;
    },
  },
  methods: {
    // 부모에게 event 전달
