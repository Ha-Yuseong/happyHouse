        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">매물 수정</h1>
              <span class="color-text-a">나의 매물을 수정해보세요!</span>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="card-body">
              ...
              <div class="row mb-3">
                ...
                <div class="row mb-3" style="margin-left: 85%">
                  <div class="col-sm-12">
                    <button @click="houseUpdate" class="propertyRegistBtn float-end" style="width:15vh; font-size:19px" >수정</button>
                  </div> 
                </div>
